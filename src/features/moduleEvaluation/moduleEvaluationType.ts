...
export type IModuleEvaluationColumnKey = "grade" | "comment" | "moduleProgressStatus" | "evaluationInstrumentId" | "enrollmentId" | "createdBy" | "trainingModuleId" ;
...
export interface ModuleEvaluationTableProps extends Pick<ModuleEvaluationListResult, "moduleEvaluationsList" > {
}
