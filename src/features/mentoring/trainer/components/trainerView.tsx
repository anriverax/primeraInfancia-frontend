...
const attachmentList = [
    {
        ...
        title: "Guía de observación y medición del grado de implementación del diseño curricular para la transformación de las prácticas docentes en la aulas de primera infancia de El Salvador",
        phase: "Al finalizar la formación",
        order: "Anexo 1",
        description: "Documento inicial que establece los términos y objetivos de la mentoría",
        icon: Eye,
