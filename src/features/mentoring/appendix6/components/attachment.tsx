...
import { IAppendix6Input } from "../type";
import Link from "next/link";

type Appendix6FormProps = {
  formik: FormikProps<IAppendix6Input>;
};

const Appendix6Form = ({ formik }: Appendix6FormProps): React.JSX.Element => {
