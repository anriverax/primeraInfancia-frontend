...
export interface PrincipalSchoolListResult {
  ...
  onDeletePrincipalSchool: (_principalSchoolId: number) => Promise<void>;
  setPrincipalSchoolsList: (_PrincipalSchools: IPrincipalSchoolTable[]) => void;
}

/* eslint-disable @typescript-eslint/no-explicit-any */
export interface PrincipalSchoolTableProps extends Pick<PrincipalSchoolListResult, "PrincipalSchoolsList" | "onDeletePrincipalSchool"> {
