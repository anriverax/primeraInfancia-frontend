...
const AccordionLayout = ({
  ...
  <Accordion
    itemClasses={{
      base: "hover:cursor-pointer border-white data-[open=true]:px-4 data-[open=true]:bg-white data-[open=true]:border data-[open=true]:border-gray-200 data-[open=true]:shadow-none data-[open=true]:rounded-medium data-[open=true]:mb-8 transition-all"
    }}
