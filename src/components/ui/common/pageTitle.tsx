...
export const PageTitle = ({ title, iconName, imageSrc }: PageTitleProps): React.JSX.Element => (
  <div className="flex flex-col gap-6 w-full p-6 mb-6 rounded-lg bg-[#e9f8ff] relative">
