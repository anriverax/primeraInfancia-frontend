...
import SchoolLayout from "@/features/school/component/schoolLayout";
  ...
  return (
    <div className="space-y-8">
      <div className="flex w-full gap-3 justify-start ">
        <School className="h-5 w-5 text-blue-500" /><h1 className="text-2xl font-bold text-gray-900">Centro Escolar</h1>
