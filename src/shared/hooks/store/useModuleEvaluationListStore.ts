...
type ModuleEvaluationListStoreProps = {
  ...
  setModuleEvaluationsList: (
    _moduleEvaluations:
      | IModuleEvaluationTable[]
      | ((_prev: IModuleEvaluationTable[]) => IModuleEvaluationTable[])
  ) => void;
};
...
export const useModuleEvaluationListStore: UseBoundStore<StoreApi<ModuleEvaluationListStoreProps>> =
  create<ModuleEvaluationListStoreProps>()((set) => ({
    ...
    setModuleEvaluationsList: (
      ...
      set((state) => ({
        moduleEvaluationsList:
          typeof moduleEvaluations === "function"
            ? moduleEvaluations(state.moduleEvaluationsList)
            : moduleEvaluations
      }))
  }));
